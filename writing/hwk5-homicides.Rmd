...
Source: https://github.com/washingtonpost/data-homicides
...
ggplot2::ggplot(baltimore_monthly,
  ...
  # Vertical reference line: arrest of Freddie Gray on April 12, 2015
...
ggplot2::ggsave(
  filename = "figures/baltimore-monthly.png",
...
Cold months were defined as November–April, while warm months were defined as May–October. 
This follows the pattern used in the original Washington Post figure.

### 7. Methods summary

I used ggplot2::geom_smooth() with method = "loess", which is appropriate for seasonal trend visualization.

Steps included:
- Filtering Baltimore cases  
- Converting reported_date to YYYY-MM-DD  
- Aggregating monthly  
- Creating season variable  
- Plotting with loess trend + reference line  
...
The project root is enforced using knitr::opts_knit$set(root.dir = '..') so knitting works regardless of the working directory.
