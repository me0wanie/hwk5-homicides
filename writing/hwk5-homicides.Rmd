...
In this homework, I used the Washington Post homicide dataset and focused on
homicides in Baltimore, Maryland. I converted the reported homicide dates into
proper Date objects, aggregated counts to the monthly level, and created an
indicator for “cold” months (November–April) versus “warm” months (May–October).
I then used these monthly counts to build a time-series plot with a loess smooth
to highlight seasonal and long-term patterns, and added a vertical reference
line for the arrest date of Freddie Gray.

### 8. Interpretation

The plot shows clear seasonal patterns in Baltimore homicides.  
Warm months (May–October) generally have higher homicide counts than cold months.  
There is a noticeable increase in variability around 2014–2016, including a sharp spike shortly after the arrest of Freddie Gray in April 2015.  
The smooth line highlights a long-term upward trend from 2011–2017.